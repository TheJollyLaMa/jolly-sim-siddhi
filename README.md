...
- <img src="https://bafybeihx7bjavlb6uicr4d3osgrduatte3jtsfrfs2exrymmauw4dbgwvm.ipfs.w3s.link/SimSiddhiDefi.png" alt="DecentMarketMaker Logo" width="20" height="20"> **Decent Maker:** Decent Maker is a collection of Market Maker prototypes and sandbox frankensteins to help a home stabilize the markets they are participating in while capturing value with standby capital.  Projects in the pipeline include targeted arbitrage, portfolio allocator and protector, DeFi lending with locked LP tokens   : [DecentMaker](https://www.mintme.com/explorer/token/0x969d65ee0823F9c892bDFe3c462D91ab1D278B4E)
- <img src="https://bafybeigyxy4hs6pweqofwikwlwmvxyykwlhr3yxx4fg3th6aflvdf5ekha.ipfs.w3s.link/ComposToken.gif" alt="ComposToken Logo" width="20" height="20"><img src="https://bafybeig67sj4te7xkz5ku67ksnhxdfzikblc77gsecv53owxe6b4z5aega.ipfs.w3s.link/MintMeLogo.png" alt="MintMe Logo" width="10" height="10"> **ComposToken:** ComposToken is a new way to generate, store, and exchange wealth at home - while accounting for it on a Global Market! It is a token that is minted by the community and can be used to reward stewards for their shared data and participation in bettering their local environment through various composting methods. It's a great way to onboard new Food Forest Warriors and Decent Smart Home Stewards.  Learn more here: [ComposToken](https://www.mintme.com/token/ComposToken)
...
- 🚧 **ComposToken Pilot Program:** ComposToken as a way to generate, store, and exchange wealth at home.
...
<div align="center">
    ...
    <img src="https://bafybeigyxy4hs6pweqofwikwlwmvxyykwlhr3yxx4fg3th6aflvdf5ekha.ipfs.w3s.link/ComposToken.gif" alt="ComposToken Logo" width="50" height="50">
