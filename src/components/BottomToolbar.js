...
const BottomToolbar = ({ walletAddress }) => {
  ...
  return (
    <div id="bottomToolbar">
      ...
      <img
          src="https://bafybeia7dr3aeh53mmqxnpwfga2zflp2u6msvwih4iiziwrfxct5ti4of4.ipfs.w3s.link/SimSiddhiChat.png" // Sim Siddhi Chat icon
          alt="Chat Icon"
          className="chat-icon"
        ...
        />
        <img
          src="https://bafybeid6y5ibkrn2y7ddkolpzo53i7rbdbjxscmivbrmq4vtrapnl6l5wa.ipfs.w3s.link/DoctorBuddha.png" // DoctorBuddha icon
        ...
        />
        <img
          src="https://bafybeidpjh43gomls6rkxym4cbetd6cufc7y3uhplgo5ur7ufjeg5fdghi.ipfs.w3s.link/WOTSERWell.jpeg" // DoctorBuddha icon
          alt="WotserWell Icon"
